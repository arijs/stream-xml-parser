...
import testListFunc from './testlist.js';
import printerTransformFunc from './printertransform.js';

const __dirname = dirname(fileURLToPath(import.meta.url));

const XMLParser = xmlParserModule.XMLParser;
const TreeBuilder = xmlParserModule.TreeBuilder;
const TreeMatcher = xmlParserModule.TreeMatcher;
const treeStats = xmlParserModule.treeStats;
const treeRender = xmlParserModule.treeRender;
const treeWalk = xmlParserModule.treeWalk;
const elementDefault = xmlParserModule.elementDefault;
const elementSnabbdom = xmlParserModule.elementSnabbdom;
const Printer = xmlParserModule.Printer;
const testList = testListFunc;
const printerTransform = printerTransformFunc;
